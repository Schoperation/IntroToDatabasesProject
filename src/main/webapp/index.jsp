...
<body onload=changeForm()>
    ...
    <table id="formTbl1">
       <tr><td><h4>Fill in the information to your heart&#39;s desire. Not all need to be filled in, but at least one field does.</h4></td></tr>
        ...
        <input type="text" id="Home1_home.homeID" name="Home1_home.homeID" size=12 /><br /></td></tr>

        <tr><td><label for="Home1_floors">Floors (exact): </label>
        <input type="text" id="Home1_floors" name="Home1_floors" size=12 /><br /></td></tr>

        <tr><td><label for="Home1_bedrooms">Bedrooms (exact): </label>
        <input type="text" id="Home1_bedrooms" name="Home1_bedrooms" size=12 /><br /></td></tr>

        <tr><td><label for="Home1_bathrooms"> Bathrooms (exact): </label>
        <input type="text" id="Home1_bathrooms" name="Home1_bathrooms" size=12 /><br /></td></tr>
        ...
        <input type="text" id="Home1_landAcres_max" name="Home1_landAcres_max" size=6 /><br /></td></tr>
        ...
        <input type="text" id="Home1_floorSpace_max" name="Home1_floorSpace_max" size=6 /><br /></td></tr>
        ...
        <input type="text" id="Home1_yearConstructed" name="Home1_yearConstructed" size=12 /><br /></td></tr>
        ...
        <input type="text" id="Home1_price_max" name="Home1_price_max" size=6 /><br /></td></tr>
        ...
        <input type="text" id="Home1_ssNumber" name="Home1_ssNumber" size=12 /><br /></td></tr>

        <tr><td><label for="Home1_agentID">Agent ID: </label>
        <input type="text" id="Home1_agentID" name="Home1_agentID" size=12 /><br /></td></tr>
    </table>
    </div>
    ...
    <table id="formTbl2">
        ...
        <input type="text" id="Owner1_ssNumber" name="Owner1_ssNumber" size=12 /><br /></td></tr>
    </table>
    </div>
    ...
    <table id="formTbl3">
        ...
        <input type="text" id="Agent1_agentID" name="Agent1_agentID" size=12 /><br /></td></tr>
    </table>
    </div>
    ...
    <table id="formTbl5">
        ...
        <input type="text" id="newssNumber" name="newssNumber" size=12 /><br /></td></tr>

        <tr><td><label for="newHomeID">Enter the ID of the Home: </label>
        <input type="text" id="newHomeID" name="newHomeID" size=12 /><br /></td></tr>

        <tr><td><label for="newPrice">Enter the Price: </label>
        <input type="text" id="newPrice" name="newPrice" size=12 /><br /></td></tr>
    </table>
    </div>
    ...
    <div id="addEntry">
        ...
        <table id="myTestTable_divadd">
            ...
            <input type="text" id="myTestTable_id" name="myTestTable_id" size=4 /><br /></td></tr>
        </table>
        <table id="Agent_divadd">
            <tr><td><label for="Agent_percentCommission">% Commission: </label>
            <input type="text" id="Agent_percentCommission" name="Agent_percentCommission" size=4 /><br /></td></tr>
            ...
            <input type="text" id="Agent_agentID" name="Agent_agentID" size=6 /><br /></td></tr>
        </table>
        <table id="Appliance_divadd">
            ...
            <input type="text" id="Appliance_price" name="Appliance_price" size=6 /><br /></td></tr>
            ...
            <input type="text" id="Appliance_year" name="Appliance_year" size=12 /><br /></td></tr>
            ...
            <input type="text" id="Appliance_homeID" name="Appliance_homeID" size=12 /><br /></td></tr>
        </table>
        <table id="Home_divadd">
            <tr><td><label for="Home_homeID">Home ID: </label>
            <input type="text" id="Home_homeID" name="Home_homeID" size=12 /><br /></td></tr>

            <tr><td><label for="Home_floors">Floors: </label>
            <input type="text" id="Home_floors" name="Home_floors" size=12 /><br /></td></tr>

            <tr><td><label for="Home_bedrooms">Bedrooms: </label>
            <input type="text" id="Home_bedrooms" name="Home_bedrooms" size=12 /><br /></td></tr>

            <tr><td><label for="Home_bathrooms"> Bathrooms: </label>
            <input type="text" id="Home_bathrooms" name="Home_bathrooms" size=12 /><br /></td></tr>

            <tr><td><label for="Home_landAcres">Land Acres: </label>
            <input type="text" id="Home_landAcres" name="Home_landAcres" size=12 /><br /></td></tr>

            <tr><td><label for="Home_floorSpace">Floor Space (sqft): </label>
            <input type="text" id="Home_floorSpace" name="Home_floorSpace" size=12 /><br /></td></tr>
            ...
            <input type="text" id="Home_yearConstructed" name="Home_yearConstructed" size=12 /><br /></td></tr>

            <tr><td><label for="Home_price">Price: </label>
            <input type="text" id="Home_price" name="Home_price" size=12 /><br /></td></tr>
            ...
            <input type="text" id="Home_ssNumber" name="Home_ssNumber" size=12 /><br /></td></tr>

            <tr><td><label for="Home_agentID">Agent ID: </label>
            <input type="text" id="Home_agentID" name="Home_agentID" size=12 /><br /></td></tr>
        </table>
        <table id="HomeTransaction_divadd">
            <tr><td><label for="HomeTransaction_transID">Trans ID: </label>
            <input type="text" id="HomeTransaction_transID" name="HomeTransaction_transID" size=12 /><br /></td></tr>

            <tr><td><label for="HomeTransaction_homeID">Home ID: </label>
            <input type="text" id="HomeTransaction_homeID" name="HomeTransaction_homeID" size=12 /><br /></td></tr>

            <tr><td><label for="HomeTransaction_ssNumber">SS Number: </label>
            <input type="text" id="HomeTransaction_ssNumber" name="HomeTransaction_ssNumber" size=12 /><br /></td></tr>

            <tr><td><label for="HomeTransaction_agentID">Agent ID: </label>
            <input type="text" id="HomeTransaction_agentID" name="HomeTransaction_agentID" size=12 /><br /></td></tr>

            <tr><td><label for="HomeTransaction_price">Price: </label>
            <input type="text" id="HomeTransaction_price" name="HomeTransaction_price" size=12 /><br /></td></tr>
        </table>
        <table id="Location_divadd">
            <tr><td><label for="Location_streetNumber">Street Number: </label>
            <input type="text" id="Location_streetNumber" name="Location_streetNumber" size=12 /><br /></td></tr>
            ...
            <input type="text" id="Location_unitNumber" name="Location_unitNumber" size=12 /><br /></td></tr>
            ...
            <input type="text" id="Location_zipCode" name="Location_zipCode" size=12 /><br /></td></tr>
            ...
            <input type="text" id="Location_homeID" name="Location_homeID" size=12 /><br /></td></tr>
        </table>
        <table id="Owner_divadd">
            ...
            <input type="text" id="Owner_ssNumber" name="Owner_ssNumber" size=12 /><br /></td></tr>

            <tr><td><label for="Owner_age">Age: </label>
            <input type="text" id="Owner_age" name="Owner_age" size=12 /><br /></td></tr>

            <tr><td><label for="Owner_dependents"># of Dependents: </label>
            <input type="text" id="Owner_dependents" name="Owner_dependents" size=12 /><br /></td></tr>

            <tr><td><label for="Owner_yearlyIncome">Yearly Income: </label>
            <input type="text" id="Owner_yearlyIncome" name="Owner_yearlyIncome" size=12 /><br /></td></tr>
