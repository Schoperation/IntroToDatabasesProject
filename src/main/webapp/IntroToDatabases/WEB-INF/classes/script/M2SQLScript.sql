...
CREATE USER MCS IDENTIFIED BY mohammed; 
GRANT CREATE SESSION TO MCS;
GRANT CREATE TABLE TO MCS;
GRANT CREATE SEQUENCE TO MCS;
ALTER USER MCS QUOTA UNLIMITED ON USERS;

connect MCS/mohammed;
